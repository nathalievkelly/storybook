    ...
    this.getStorybookUI = function () {
      ...
      if (!channel || params.resetStorybook) {
        if (onDeviceUI && params.disableWebsockets) {
          ...
          var port = params.port ? ":".concat(params.port || 7007) : '';
      ...
      _addons["default"].loadAddons(_this._clientApi); // react-native hot module loader must take in a Class - https://github.com/facebook/react-native/issues/10991
